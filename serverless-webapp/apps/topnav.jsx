              ...
              <div className="background">
               ...
               <div className="row">
                 <div className="col l2 m2 s2">
                   <a href="https://github.com/ChestnutKurisu/"><i className="fab fa-github fa-lg"></i></a>
                 </div>
                 <div className="col l2 m2 s2">
                   <a href="https://www.linkedin.com/in/"><i className="fab fa-linkedin fa-lg"></i></a>
                 </div>
                 <div className="col l2 m2 s2">
                   <a href="https://medium.com"><i className="fab fa-medium fa-lg"></i></a>
                 </div>
                 <div className="col l2 m2 s2">
                   <a href="mailto:param.somane@xcissa.com"><i className="fa fa-envelope fa-lg"></i></a>
                 </div>
              </div>
            </div>
          </li>
          <li><a href="https://drive.google.com/file/d/0B_uByl2mOTJIVTM3ZWRYRVpIcWs/view">Resume</a></li>
          <li><a href="http://chestnutkurisu.github.io/#work">Work</a></li>
          <li><a href="http://chestnutkurisu.github.io/#writing">Writing</a></li>
          <li><a href="http://chestnutkurisu.github.io/consulting/global-dev-corp/feedback-for-website.html">Consulting</a></li>
