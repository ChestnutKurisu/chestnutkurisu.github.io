            ...
            <div className="col l8 s12">
              <p className="blue-grey-text text-lighten-1">Made with
                ...
                <a target="_blank" href="http://materializecss.com/">
                  {' MaterializeCSS '}
                </a>with <i className="fas fa-heart"></i> by <a href="http://chestnutkurisu.github.io/">Param Somane</a>.
              </p>
              <p className="blue-grey-text text-lighten-1">
                View source code
                <a href="https://github.com/ChestnutKurisu//serverless-webapp-no-internet">
                  {' here'}
                </a>
              </p>
            </div>
